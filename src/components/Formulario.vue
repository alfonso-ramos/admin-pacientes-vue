...
<template>
    <div class="md:w-1/2">
        ...
        <form class="bg-white shadow-md rounded-lg py-10 px-5 mb-10" action="" @submit.prevent="validar">
            <div class="mb-5">
                <label for="mascota" class="block text-gray-700 uppercase font-bold">
                    Nombre Mascota
                </label>
                <input placeholder="Nombre de la mascota" class="border-2 w-full p-2 mt-2 placeholder-gray-400 rounded-md"
                    id="mascota" :value="nombre" type="text" @input="$emit('update:nombre', $event.target.value)">
            </div>
